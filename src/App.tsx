...
const App = () => {
  ...
  const numero = "+5521965385878"; // número do personal sem espaços
  ...
  return (
    <div className=" min-h-screen bg-stone-50 text-stone-900 font-sans selection:bg-orange-100 selection:text-orange-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 md:h-20 items-center">
            <span className="text-xl md:text-2xl font-black tracking-tighter text-stone-900">
              André Dieyson <br /> <span className="text-orange-600">Personal Trainer</span>
            </span>
            ...
            <div className="hidden md:flex space-x-8 items-center">
              {["sobre", "servicos", "testemunhos"].map((s) => (
                ...
                >
                  {s === "testemunhos" ? "Resultados" : s.charAt(0).toUpperCase() + s.slice(1)}
                </button>
              ))}
              <button
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-10 md:mt-12 flex items-center space-x-4 grayscale opacity-60">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-white bg-stone-300" />
                ))}
              </div>
              <p className="text-xs md:text-sm font-medium text-stone-500">
                +200 alunos transformados em Portugal
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="relative mx-auto w-full max-w-sm md:max-w-none">
              <div className="aspect-[4/5] bg-stone-200 rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center border-4 border-white">
                <span className="text-stone-400 font-medium text-sm text-center px-4">
                  [Foto Profissional André]
                </span>
              </div>
              <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 bg-orange-600 text-white p-5 md:p-8 rounded-2xl md:rounded-3xl shadow-xl">
                ...
                <p className="text-lg md:text-2xl font-black">IPDJ #12345</p>
              </div>
            </div>
            ...
            <div className="mt-8 md:mt-0">
              ...
              <p className="text-base md:text-lg text-stone-600 mb-7 md:mb-8 leading-relaxed">
                Olá, sou o <strong>André Dieyson</strong>. Especialista em recomposição
                corporal e treino de força. Acredito que o fitness deve
                simplificar a tua vida, não complicá-la. O meu método baseia-se
                em ciência, sem dietas restritivas ou treinos intermináveis.
              </p>
      ...
      <section id="servicos" className="py-16 md:py-24 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
          ...
          <div className="p-7 md:p-8 rounded-3xl border border-stone-100 bg-stone-50 hover:border-orange-200 transition-all hover:shadow-xl group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">PT Presencial</h3>
            ...
            <p className="text-stone-400 text-sm italic mb-5 md:mb-6">Desde 35€ / sessão</p>
            <button
              onClick={() => scrollTo("contacto")}
          ...
          <div className="p-7 md:p-8 rounded-3xl bg-stone-900 text-white shadow-2xl md:-translate-y-4 border border-stone-800">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Consultoria Online</h3>
            ...
            <p className="text-stone-300 text-sm italic mb-5 md:mb-6">Apenas 69€ / mês</p>
            <button
              onClick={() => scrollTo("contacto")}
          ...
          <div className="p-7 md:p-8 rounded-3xl border border-stone-100 bg-stone-50 hover:border-orange-200 transition-all hover:shadow-xl group">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Plano Elite</h3>
            <p className="text-stone-600 mb-4 md:mb-6 text-sm md:text-base">
              Treino, nutrição e análise de exames. Acompanhamento diário para
              objetivos de alta performance.
            </p>
            <p className="text-stone-400 text-sm italic mb-5 md:mb-6">Sob consulta</p>
            <button
              onClick={() => scrollTo("contacto")}
              className="w-full py-3 text-stone-900 font-bold border-b-2 border-stone-200 hover:border-orange-600 transition-colors text-left flex items-center justify-between text-sm md:text-base"
            >
            ...
            {[
              ...
              >
                <div className="flex items-center mb-5 md:mb-6">
                  <div className="w-11 h-11 md:w-12 md:h-12 bg-stone-300 rounded-full mr-4 shrink-0" />
                  <div>
                    <h4 className="font-bold text-stone-900 text-sm md:text-base">{name}</h4>
                    <p className="text-xs md:text-sm text-stone-400">{result}</p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="space-y-5 md:space-y-6">
                {[
                  ...
                  { icon: Phone, text: "+351 912 345 678" },
                ].map(({ icon: Icon, text }) => (
                  <div key={text} className="flex items-center space-x-4">
                    ...
                    <span className="text-stone-300 text-sm md:text-base">{text}</span>
                  </div>
                ))}
              </div>
      ...
      <footer className="py-8 md:py-12 bg-stone-50 border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 text-center md:text-left">
          <span className="text-xl font-black tracking-tighter text-stone-900">
            STUDIO<span className="text-orange-600">FIT</span>
          </span>
